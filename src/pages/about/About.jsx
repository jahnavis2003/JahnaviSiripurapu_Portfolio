...
const AboutMe = () => {
  return (
    <motion.div 
      className='relative flex flex-col items-center justify-center min-h-screen p-14 py-0 scrollbar-hide'
    >
      <AboutHeader />
      <div className='xxl:h-[70vh] pt-36 sm:pt-32 xxl:pt-0'>
        <p className='text-fuchsia-100 text-xl sm:text-2xl p-10 text-center whitespace-pre-line'>
