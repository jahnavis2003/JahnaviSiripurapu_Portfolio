...
const SKILLS = [
  ...
  { id: 'next-js',          label: 'Next.js',      category: 'Frontend', level: 80, featured: true, Icon: NextJsIcon },
  { id: 'react-native',     label: 'React Native', category: 'Frontend', level: 80, featured: true, Icon: ReactNativeIcon },
  { id: 'java',             label: 'Java',         category: 'Backend',  level: 40, featured: true },
  { id: 'javascript',       label: 'JavaScript',   category: 'Frontend', level: 90 },
  { id: 'html',             label: 'HTML',         category: 'Frontend', level: 90 },
  { id: 'css',              label: 'CSS',          category: 'Frontend', level: 80 },
  { id: 'redux',            label: 'Redux',        category: 'Frontend', level: 70 },
  { id: 'bootstrap',        label: 'Bootstrap',    category: 'Frontend', level: 70 },
  { id: 'tailwind-css',     label: 'Tailwind CSS', category: 'Frontend', level: 80 },
  { id: 'node-js',          label: 'Node.js',      category: 'Backend',  level: 70, featured: true },
  { id: 'express-js',       label: 'Express.js',   category: 'Backend',  level: 70 },
  { id: 'dotnet-framework', label: '.NET',         category: 'Backend',  level: 60 },
  { id: 'my-sql',           label: 'MySQL',        category: 'Database', level: 70 },
  { id: 'mongodb',          label: 'MongoDB',      category: 'Database', level: 60, Icon: MongoDBIcon },
  { id: 'figma',            label: 'Figma',        category: 'Design',   level: 70 },
  { id: 'adobe-xd',         label: 'Adobe XD',     category: 'Design',   level: 60 },
  { id: 'github',           label: 'GitHub',       category: 'Tools',    level: 80 },
  { id: 'git',              label: 'Git',          category: 'Tools',    level: 80 },
  { id: 'aws',              label: 'AWS',          category: 'Tools',    level: 50, Icon: AWSIcon },
];
